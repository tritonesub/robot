...
public:
	...
	static void i2c_write(uint8_t address, const uint8_t reg, const uint8_t data);
	static void i2c_write(uint8_t address, const uint8_t reg, std::vector<uint8_t>& writeBuf);
	static void i2c_write(uint8_t address, const std::vector<uint8_t>& writeBuf);
	static void i2c_write(uint8_t  address, const uint8_t value);
